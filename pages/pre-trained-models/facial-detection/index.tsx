...
import { facialDetectionSampleImages } from "common_functions/sample_images.ts/facialDetectionSampleImages";
// toasts
...
const facialDetection: FC = () => {
  ...
  const [test_array, setTest_array] = useState(facialDetectionSampleImages);
  ...
  const resetAll = (e) => {
    ...
    setTest_array(facialDetectionSampleImages);
    setSelectedImages([]);
  };
  ...
  const imageClick = (image) => {
    ...
    //Reset Upload images
    setSelectedImages([]);
    let updated_sample = facialDetectionSampleImages.map((item: any) => {
      if (item.id == image.id) {
        return {
          id: image.id,
        ...
        <div className="">
          <div className="row mx-5 my-5">
            ...
            <div className="card border-0 p-3 bg-white">
              <div className="">
                <h4 className="page-title ms-3">Facial detection</h4>
              </div>
            </div>
            ...
            <div className="card border-0 bg-white pb-3">
              <div className="my-2 mx-4 page-content">
                <p className="mb-3">
                  Detect single/multiple faces in an image. To test run your model, either select an
                  image from the sample images provided below or upload your own image/image URL.
                  The model will detect all faces within a selected image, and emphasize the faces
                  with bounding boxes.
                </p>
              </div>
              <SampleCodeAccordion
                  ...
                  <div className="container">
                    ...
                    <div className="mt-2 ">
                      {loading ? (
                        ...
                        <h5 className="mt-2 result-content">
                          Number Of Faces Detected: {result.no_of_faces}{" "}
                        </h5>
                      )}
                    </div>
                  </div>
