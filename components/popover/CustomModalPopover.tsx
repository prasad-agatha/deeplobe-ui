import CustomNotesUpdateModal from "@components/modals/CustomNotesUpdateModal";
import CustomUpdateModal from "@components/modals/CustomUpdateModal";
...
const CustomModalPopover = ({ row, mutate }) => {
          ...
          <div>
            ...
            <div className="d-flex mt-4">
              <button
                ...
                onClick={async () => {
                  await supportService.deleteCustom(deleteModal);
                  mutate();
...
export default CustomModalPopover;
