import HireAnnotationNotesModal from "@components/modals/HireAnnotationNotesModal";
import HireAnnotationUpdateModal from "@components/modals/HireAnnotationUpdateModal";
...
const HireAnnotationPopover = ({ row, mutate }) => {
  ...
  return (
    <>
      ...
      <HireAnnotationUpdateModal
        updateModal={updateModal}
        setUpdateModal={setUpdateModal}
        row={row}
        mutate={mutate}
      />
      <HireAnnotationNotesModal
          ...
          <div>
            ...
            <div className="d-flex mt-4">
              <button
                ...
                onClick={async () => {
                  await supportService.deleteHire(deleteModal);
                  mutate();
...
export default HireAnnotationPopover;
