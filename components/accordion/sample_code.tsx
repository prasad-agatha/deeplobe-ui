        ...
        <Card className="border-0">
          <Card.Header className="block-background" style={{ border: "None" }}>
            <div className="d-flex flex-wrap justify-content-between">
              <Accordion.Toggle
                eventKey="0"
                className="border-0 font-inter font-14 text-start w-50"
              ...
              <Link href={`/api-documentation/#${modelName}`} passHref>
                <a
                  target="_blank"
                  className="text-primary font-inter font-14 border-0 text-right"
                  style={{ background: "None" }}
                >
                        ...
                        {number_of_files === 2 ? (
                          <>
                            ...
                            <p className="code-blue my-0 font-mono text-nowrap pe-3">
                              ...
                              <span className="code-purple">{url2}</span>
                    ...
                    {data_format === "formdata" ? (
                        ...
                        {number_of_files === 1 ? (
                          <>
                            ...
                            <p className="code-blue my-0 font-mono text-nowrap pe-3">
                              ...
                              &nbsp;&nbsp; &nbsp;&nbsp; console.
                              <span className="code-yellow">log</span>
                              &#40;body&#41;
                            </p>
                            <p className="code-blue my-0 font-mono text-nowrap pe-3">
                      ...
                      <>
                        <>
                          ...
                          <p className="code-blue my-0 font-mono text-nowrap pe-3">
                            <small className="code-numbers me-3 my-0">2</small>
                            <span className="code-white"> const payload</span> &#61;{" "}
                            {nodejs_payload}
                          </p>
                          <p className="code-blue my-0 font-mono text-nowrap pe-3">
                            <small className="code-numbers me-3 my-0">3</small>
...
export default SampleCodeAccordian;
